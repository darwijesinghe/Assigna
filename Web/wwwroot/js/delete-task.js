...
// hooks event to button
delButton && delButton.addEventListener("click", (e) => {
    try {
        Confirm.show(
            "Delete Confirmation",
...
// button event
remButton && remButton.addEventListener("click", (e) => {
    try {
...
const SendMail = {
    show(id, name, token) {
        try {
            ...
            // button event
            mailForm && mailForm.addEventListener("submit", (e) => {
                try {

                    // binds form data to model
                    const formData = new FormData();
                    formData.append("TaskId", mailTo.value);
